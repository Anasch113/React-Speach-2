            ...
            <Wrapper>
                <div className="min-h-screen bg-black flex items-center justify-center p-4 md:px-40 w-full">
                    <div className="bg-black text-white bg-opacity-90 md:p-8 rounded-lg shadow-lg w-full">
                        ...
                        <p className=" md:text-xl font-light text-white mb-6">With Captify, captivate your audience, deliver dynamic presentations, meetings, and events with confidence and clarity.
