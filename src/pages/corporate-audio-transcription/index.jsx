                ...
                <section className="flex items-center justify-between w-full md:flex-row flex-col">
                    <div className="my-5 md:my-24 md:pr-20 text-white md:w-1/2">
                        ...
                        <p className="lg:text-lg font-normal my-8 text-center md:text-left">
                            Our AI-powered transcription system handles various file types, delivering fast and accurate transcripts. You can also request a human review for additional accuracy.
                        </p>
                        <button className="mt-6 px-6 mx-auto md:mx-0 w-full md:w-auto py-3 bg-[#A100FF] text-white">
                            Upload Files Now
                        </button>
                    </div>
                    ...
                    <div className="flex flex-wrap mt-10 gap-10 justify-center">
                        ...
                        <div className="space-y-1 hover:translate-y-4 cursor-pointer duration-300 max-w-[450px] md:max-h-[240px] bg-slate-900 px-4 md:px-10 py-6 rounded-3xl">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <h3 className="text-xl font-semibold">Human Review Option</h3>
                            </div>
                            <p className="text-sm md:text-base">
                                For more complex transcripts, request a human review and receive the final version within 72 hours.
                            </p>
                        </div>
