                ...
                <form onSubmit={handleSubmit} className="mx-4 md:mx-10">
                    ...
                    <div className="flex  mt-3 flex-row justify-between items-center">
                        ...
                        <div className="flex md:justify-end items-center md:mt-2">
                            <a className=" text-white text-sm md:text-[16px] hover-underline-animation" href="/auth/login">
                                Forgot Password?
                            </a>
                        </div>
                    </div>
                    ...
                    <Link to={'/dashboard'}>
                        <button
                            type="submit"
                            className="customBtn1 w-full mt-8 py-2 px-4 rounded-lg bg-[#460073] text-white hover:bg-opacity-90"
                        >
                            Login
                        </button>
                    </Link>
