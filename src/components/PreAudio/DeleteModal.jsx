...
const DeleteModal = ({ deleteTranscript, setShowDeleteModal, filename, type }) => {
    ...
    return (
        <div className="fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-gray-500 bg-opacity-50 ">
            ...
            <div className="bg-black min-h-[270px] w-[500px] p-5 rounded-2xl ">

                <div className='w-full  flex flex-row items-center justify-end  gap-10 px-5 py-5'>

                    <span className='flex  flex-row items-center gap-2'>
                        <RiDeleteBin6Line className='text-2xl' />
                        <h1 className='md:text-2xl font-semibold font-poppins '> Delete {type === "ocr" ? 'Ocr File' : 'Transcript'} </h1>
                    </span>
...
rounded-md bg-red-500 text-white text-xl font-medium font-roboto hover:bg-red-600 '><span className='flex items-center text-center justify-center gap-2'>
