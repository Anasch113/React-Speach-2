        ...
        <div className="max-h-[120px] pb-9 bg-black text-white">
            ...
            <div className="w-full flex justify-between items-center relative">
                ...
                <a href="/" className="custom__logo md:block hidden group mx-auto md:mx-20 z-20 md:z-50">
                    <img src={logo} alt="logo" className="md:group-hover:scale-[.3]  md:group-hover:-translate-x-6 md:group-hover:-translate-y-2" />
                    <h1 className="custom__logo__text md:block hidden group-hover:-translate-y-12 md:group-hover:-translate-y-8">Bradley Reporting</h1>
                </a>
